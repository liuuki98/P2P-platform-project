...
import com.liuuki.srb.service.LendItemService;
...
public class LendItemController {
    ...
    public String notify(HttpServletRequest request) {
        ...
        if(RequestHelper.isSignEquals(paramMap)) {
            if("0001".equals(paramMap.get("resultCode"))) {
                lendItemService.notified(paramMap);
            } else {
    ...
    public R list(
        ...
        List<LendItem> list = lendItemService.selectByLendIdNoStatus(lendId);

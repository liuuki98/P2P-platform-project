...
import com.liuuki.srb.dao.LendItemMapper;
import com.liuuki.srb.dao.LendMapper;
...
import com.liuuki.srb.enums.LendStatusEnum;
import com.liuuki.srb.enums.TransTypeEnum;
import com.liuuki.srb.hfb.FormHelper;
import com.liuuki.srb.hfb.HfbConst;
import com.liuuki.srb.hfb.RequestHelper;
import com.liuuki.srb.service.*;
import com.liuuki.srb.util.LendNoUtils;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public String commitInvest(InvestVO investVO) {
        ...
        Assert.isTrue(sum.doubleValue() <= lend.getAmount().doubleValue(),
                ResultEnum.LEND_FULL_SCALE_ERROR);
        ...
        Assert.isTrue(amount.doubleValue() >= Double.parseDouble(investVO.getInvestAmount()),
                ResultEnum.NOT_SUFFICIENT_FUNDS_ERROR);
    ...
    @Override
    public List<LendItem> selectByLendIdNoStatus(Long lendId) {
        QueryWrapper<LendItem> queryWrapper = new QueryWrapper();
        queryWrapper.eq("lend_id", lendId);
        List<LendItem> lendItemList = baseMapper.selectList(queryWrapper);
        return lendItemList;

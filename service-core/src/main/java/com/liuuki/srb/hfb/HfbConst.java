...
public class HfbConst {
     ...
     */
    //用户绑定汇付宝平台url地址
    public static final String USERBIND_URL = "http://localhost:9900/userBind/BindAgreeUserV2";
    //用户绑定异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String RECHARGE_URL = "http://localhost:9900/userAccount/AgreeBankCharge";
    //充值异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String INVEST_URL = "http://localhost:9900/userInvest/AgreeUserVoteProject";
    //充值异步回调
     ...
     * 放款
     */
    public static final String MAKE_LOAD_URL = "http://localhost:9900/userInvest/AgreeAccountLendProject";

    /**
     * 提现
     */
    //充值汇付宝平台url地址
    public static final String WITHDRAW_URL = "http://localhost:9900/userAccount/CashBankManager";
    //充值异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String BORROW_RETURN_URL = "http://localhost:9900/lendReturn/AgreeUserRepayment";
    //充值异步回调
